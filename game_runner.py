...
from B21CS062 import B21CS062 as CSP_AGENT
class GameRunner:
    """
...
if __name__ == "__main__":
    ...
    k10 = "k10.json"
    k10_data = json.load(open(k10))
    k10_data['colors'] = ["Red", "Green", "Blue", "Yellow", "Purple", "Orange", "Teal", "Pink", "Brown", "Gray"]
    with open(k10, 'w') as f: json.dump(k10_data, f)

    runner = GameRunner(k10, CSP_AGENT)
